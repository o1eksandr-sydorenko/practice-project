...
const getClicksPerUsers = () => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        const file = (0, path_1.join)(process.cwd(), "logs", "clicks.log");
        ...
        readInterface.on("close", () => {
            resolve(Object.keys(userClicks).map((key) => ({
                user: key,
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    const clicks = yield getClicksPerUsers();
    console.log({ clicks });
});
void main();
